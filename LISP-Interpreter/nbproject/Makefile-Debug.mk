...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/tests/EvalTests.o \
	${TESTDIR}/tests/EvalTestsRunner.o \
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/EvalTests.o ${TESTDIR}/tests/EvalTestsRunner.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/tests/EvalTests.o: tests/EvalTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EvalTests.o tests/EvalTests.cpp


${TESTDIR}/tests/EvalTestsRunner.o: tests/EvalTestsRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EvalTestsRunner.o tests/EvalTestsRunner.cpp


${TESTDIR}/tests/Parser2Tests.o: tests/Parser2Tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Parser2Tests.o tests/Parser2Tests.cpp
...
${OBJECTDIR}/Array_nomain.o: ${OBJECTDIR}/Array.o Array.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Array_nomain.o Array.cpp;\
	else  \
